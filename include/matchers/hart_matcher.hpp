...
/// @defgroup Signals
/// @brief Objects used to check audio

namespace hart
{

/// @grief Base for audio matchers
...
/// @brief Defines @ref Matcher::copy() and @ref Matcher::move() methods
...
/// @ingroup Matchers
#define HART_MATCHER_DEFINE_COPY_AND_MOVE(cls) \
...
/// @brief Forbids @ref Matcher::copy() and @ref Matcher::move() methods
/// @details Put this into your class body's ```public``` section if either is true:
...
///
/// Otherwise, @ref use HART_MATCHER_DEFINE_COPY_AND_MOVE() instead.
